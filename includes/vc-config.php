...
function diag_resp_view_wpbakery_element() {
    vc_map(array(
        ...
        'params' => array(
            ...
            array('type' => 'attach_media', 'heading' => 'Video/Media File', 'param_name' => 'media_id', 'dependency' => array('element' => 'is_video', 'value' => array('yes'))),
            array('type' => 'attach_image', 'heading' => 'Image', 'param_name' => 'image_id', 'dependency' => array('element' => 'is_video', 'value_not_equal_to' => 'yes'))
        )
    ));
}
